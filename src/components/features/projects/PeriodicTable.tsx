...
import ptImage from '@assets/images/periodicTable.png';

export const props: ProjectProps = {
    name: "The Periodic Table",
    desc: "A simplistic periodic table that helps you practice, allowing you to guess a secret element based on its properties.",
    date: "7/12/25",
    cardBanner: "",
    image: ptImage,
    url: "flappy-bird-network",
    live: "https://cascaade.github.io/PeriodicTableCluesGame",
    code: "https://github.com/cascaade/PeriodicTableCluesGame",
}
